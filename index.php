...
<body class="bg-slate-900 text-white font-sans min-h-screen flex flex-col justify-between">
    <header class="flex justify-between items-center p-5 border-b border-slate-800 max-w-6xl mx-auto w-full">
        ...
        <!-- Perbaikan Flexbox Tombol -->
        <div class="flex flex-row items-center gap-3">
            <a href="server/api/auth/login.php" class="px-5 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition font-medium text-sm text-white text-center whitespace-nowrap">Masuk</a>
            <a href="server/api/auth/register.php" class="px-5 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg transition font-medium text-sm text-white text-center whitespace-nowrap">Daftar</a>
        </div>
    </header>
    ...
    <footer class="text-center py-6 text-xs text-slate-500 border-t border-slate-800">
        &copy; 2026 Trading Learning Platform. Ɓy Han.
    </footer>
</body>
</html>